...
/*The image data consists of a sequence of sub-blocks containing an index into
  ...
  range of the size of the active color table, starting at 0.
  The sequence of indices is encoded using the LZW algorithm with variable-length
  code. The variable-length LZW compression is a variation of the Lempel-Ziv
  compression algorithm in which variable-length codes are used to replace
  patterns detected in the original data.
