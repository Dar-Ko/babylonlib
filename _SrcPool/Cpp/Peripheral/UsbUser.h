/*$RCSfile: UsbUser.h,v $: header file
  $Revision: 1.2 $ $Date: 2009/06/30 18:32:01 $
  $Author: ddarko $

  USB device I/O control codes for Microsoft Windows USB driver in user mode.
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /*--------------------------------------------------------------------------*/
  /*The following structures require one-byte packing.                        */
  #include <pshpack1.h>
  ...
  typedef struct _PACKET_PARAMETERS {
    ...
    ULONG       Timeout; //timeout [ms]; 0 = default timeout 10ms
    ULONG       Flags;
    ULONG       DataLength;
  ...
  typedef struct _USB_BANDWIDTH_INFO {
    ULONG   DeviceCount;
    ULONG   TotalBusBandwidth; //total bandwidth [bits/s]
    ULONG   Total32secBandwidth;
    ULONG   AllocedBulkAndControl; //allocated bandwidth  [1/32 bits/s]
    ULONG   AllocedIso;
...
/*****************************************************************************
 * $Log: UsbUser.h,v $
 * Revision 1.2  2009/06/30 18:32:01  ddarko
 * Consolidated items across the header files
 *
 *****************************************************************************/

/*Copyright (c) Microsoft Corporation. All rights reserved.
  Abstract: This file contains USER Mode IOCTLS supported by the USB PORT or
            Host Controller (HC) driver.
