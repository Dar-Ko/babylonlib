/******************************************************************************
  ...
  $Revision: 3$ $Date: 19/08/2002 9:45:08 AM$
...
typedef struct tagBITMAPINFOHEADER 
{
  ...
  WORD  biBitCount;      /* Specifies the color depth in number of bits per pixel. This
                                value must be 1, 4, 8, or 24 corresponding to 2, 16, 256 or
                            16.7 million colors*/
...
/*****************************************************************************
 * $Log: 
 *  3    Biblioteka1.2         19/08/2002 9:45:08 AMDarko Kolakovic 
 *  2    Biblioteka1.1         05/08/2002 10:33:33 AMDarko           Fixed bug in
 *       SeekImagePos
 *  1    Biblioteka1.0         02/08/2002 9:24:59 PMDarko Kolakovic 
 * $
