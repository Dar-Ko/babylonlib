...
{
return (m_pData != NULL) ? (int)m_pData->length() : 0;
}
...
void CString::SetAt(int iIndex, //[in] zero-based index of the character in the
                    //string object. The parameter must be greater than or equal
 ...
 *  10   Biblioteka1.9         2003-09-05 12:48:41  Darko
 *  9    Biblioteka1.8         2002-05-06 16:09:19  Darko           TrimLeft() If
 *       exception out_of_range is not handled, lenght exits the loop
 *  8    Biblioteka1.7         2002-01-29 23:22:14  Darko           Used lbraries
 *       notes
 *  7    Biblioteka1.6         2002-01-25 16:58:54  Darko           Updated
 *       comments
 *  6    Biblioteka1.5         2002-01-06 01:47:33  Darko
 *  5    Biblioteka1.4         2002-01-03 01:58:57  Darko           TrimLeft();
 *       TrimRight()
 *  4    Biblioteka1.3         2001-12-30 20:20:21  Darko
 *  3    Biblioteka1.2         2001-12-24 00:37:36  Darko           operators [],
 *       LPCTSR
 *  2    Biblioteka1.1         2001-11-06 15:52:36  Darko           constructors
 *  1    Biblioteka1.0         2001-11-05 15:12:59  Darko
 * $
 *****************************************************************************/
