...
#define USBPID_MSRP       0x0402 //Programmable Magnetic Swipe Card Reader, MSRP-USB
#define USBPID_IDEADAPTER 0x0500 //IDE Adapter
#define USBPID_HUBPRN     0x0501 //Hub Printer Interface
#define USBPID_HUBSNIKEY  0x0502 //Hub SNIKey Keyboard
