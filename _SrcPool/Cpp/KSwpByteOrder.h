/*$Workfile: KSwpByteOrder.h$: header file
  $Revision: 1$ $Date: 03/08/2002 6:26:10 PM$
  $Author: Darko$
...
#ifndef __KSWPBYTEORDER_H__
    //KSwpByteOrder.h sentry
  #define __KSWPBYTEORDER_H__
...
inline TSwapByteOrder<TYPE>::operator TYPE()
  {
  SwapElements(m_Value.cData, sizeof(TYPE));
  return m_Value.Data;
  }
