...
const struct SHtmlChEntity g_listHtmlChEntity[] =
  {
    ...
    {0x00AA, _T("ordf")    /*, Html3, 170 */ },//014 � feminine ordinal indicator
    ...
    {0x00B5, _T("micro")   /*, Html3, 181 */ },//025 � micro sign
    ...
    {0x00BA, _T("ordm")    /*, Html3, 186 */ },//030 � masculine ordinal indicator
    ...
    {0x00C0, _T("Agrave")  /*, Html3, 192 */ },//036 � latin capital letter A with grave
    {0x00C1, _T("Aacute")  /*, Html3, 193 */ },//037 � latin capital letter A with acute
    {0x00C2, _T("Acirc")   /*, Html3, 194 */ },//038 � latin capital letter A with circumflex
    {0x00C3, _T("Atilde")  /*, Html3, 195 */ },//039 � latin capital letter A with tilde
    {0x00C4, _T("Auml")    /*, Html3, 196 */ },//040 � latin capital letter A with diaeresis
    {0x00C5, _T("Aring")   /*, Html3, 197 */ },//041 � latin capital letter A with ring above.
    {0x00C6, _T("AElig")   /*, Html3, 198 */ },//042 � latin capital ligature AE
    {0x00C7, _T("Ccedil")  /*, Html3, 199 */ },//043 � latin capital letter C with cedilla
    {0x00C8, _T("Egrave")  /*, Html3, 200 */ },//044 � latin capital letter E with grave
    {0x00C9, _T("Eacute")  /*, Html3, 201 */ },//045 � latin capital letter E with acute
    {0x00CA, _T("Ecirc")   /*, Html3, 202 */ },//046 � latin capital letter E with circumflex
    {0x00CB, _T("Euml")    /*, Html3, 203 */ },//047 � latin capital letter E with diaeresis
    {0x00CC, _T("Igrave")  /*, Html3, 204 */ },//048 � latin capital letter I with grave
    {0x00CD, _T("Iacute")  /*, Html3, 205 */ },//049 � latin capital letter I with acute
    {0x00CE, _T("Icirc")   /*, Html3, 206 */ },//050 � latin capital letter I with circumflex
    {0x00CF, _T("Iuml")    /*, Html3, 207 */ },//051 � latin capital letter I with diaeresis
    {0x00D0, _T("ETH")     /*, Html3, 208 */ },//052 � latin capital letter ETH
    {0x00D1, _T("Ntilde")  /*, Html3, 209 */ },//053 � latin capital letter N with tilde
    {0x00D2, _T("Ograve")  /*, Html3, 210 */ },//054 � latin capital letter O with grave
    {0x00D3, _T("Oacute")  /*, Html3, 211 */ },//055 � latin capital letter O with acute
    {0x00D4, _T("Ocirc")   /*, Html3, 212 */ },//056 � latin capital letter O with circumflex
    {0x00D5, _T("Otilde")  /*, Html3, 213 */ },//057 � latin capital letter O with tilde
    {0x00D6, _T("Ouml")    /*, Html3, 214 */ },//058 � latin capital letter O with diaeresis
    {0x00D7, _T("times")   /*, Html3, 215 */ },//059 � multiplication sign
    {0x00D8, _T("Oslash")  /*, Html3, 216 */ },//060 � latin capital letter O with stroke
    {0x00D9, _T("Ugrave")  /*, Html3, 217 */ },//061 � latin capital letter U with grave
    {0x00DA, _T("Uacute")  /*, Html3, 218 */ },//062 � latin capital letter U with acute
    {0x00DB, _T("Ucirc")   /*, Html3, 219 */ },//063 � latin capital letter U with circumflex
    {0x00DC, _T("Uuml")    /*, Html3, 220 */ },//064 � latin capital letter U with diaeresis
    {0x00DD, _T("Yacute")  /*, Html3, 221 */ },//065 � latin capital letter Y with acute
    {0x00DE, _T("THORN")   /*, Html3, 222 */ },//066 � latin capital letter THORN
    {0x00DF, _T("szlig")   /*, Html3, 223 */ },//067 � latin small letter sharp s
    {0x00E0, _T("agrave")  /*, Html3, 224 */ },//068 � latin small letter a with grave
    {0x00E1, _T("aacute")  /*, Html3, 225 */ },//069 � latin small letter a with acute
    {0x00E2, _T("acirc")   /*, Html3, 226 */ },//070 � latin small letter a with circumflex
    {0x00E3, _T("atilde")  /*, Html3, 227 */ },//071 � latin small letter a with tilde
    {0x00E4, _T("auml")    /*, Html3, 228 */ },//072 � latin small letter a with diaeresis
    {0x00E5, _T("aring")   /*, Html3, 229 */ },//073 � latin small letter a with ring above
    {0x00E6, _T("aelig")   /*, Html3, 230 */ },//074 � latin small ligature ae
    {0x00E7, _T("ccedil")  /*, Html3, 231 */ },//075 � latin small letter c with cedilla
    {0x00E8, _T("egrave")  /*, Html3, 232 */ },//076 � latin small letter e with grave
    {0x00E9, _T("eacute")  /*, Html3, 233 */ },//077 � latin small letter e with acute
    {0x00EA, _T("ecirc")   /*, Html3, 234 */ },//078 � latin small letter e with circumflex
    {0x00EB, _T("euml")    /*, Html3, 235 */ },//079 � latin small letter e with diaeresis
    {0x00EC, _T("igrave")  /*, Html3, 236 */ },//080 � latin small letter i with grave
    {0x00ED, _T("iacute")  /*, Html3, 237 */ },//081 � latin small letter i with acute
    {0x00EE, _T("icirc")   /*, Html3, 238 */ },//082 � latin small letter i with circumflex
    {0x00EF, _T("iuml")    /*, Html3, 239 */ },//083 � latin small letter i with diaeresis
    {0x00F0, _T("eth")     /*, Html3, 240 */ },//084 � latin small letter eth
    {0x00F1, _T("ntilde")  /*, Html3, 241 */ },//085 � latin small letter n with tilde
    {0x00F2, _T("ograve")  /*, Html3, 242 */ },//086 � latin small letter o with grave
    {0x00F3, _T("oacute")  /*, Html3, 243 */ },//087 � latin small letter o with acute
    {0x00F4, _T("ocirc")   /*, Html3, 244 */ },//088 � latin small letter o with circumflex
    {0x00F5, _T("otilde")  /*, Html3, 245 */ },//089 � latin small letter o with tilde
    {0x00F6, _T("ouml")    /*, Html3, 246 */ },//090 � latin small letter o with diaeresis
    {0x00F7, _T("divide")  /*, Html3, 247 */ },//091 � division sign
    {0x00F8, _T("oslash")  /*, Html3, 248 */ },//092 � latin small letter o with stroke
    {0x00F9, _T("ugrave")  /*, Html3, 249 */ },//093 � latin small letter u with grave
    {0x00FA, _T("uacute")  /*, Html3, 250 */ },//094 � latin small letter u with acute
    {0x00FB, _T("ucirc")   /*, Html3, 251 */ },//095 � latin small letter u with circumflex
    {0x00FC, _T("uuml")    /*, Html3, 252 */ },//096 � latin small letter u with diaeresis
    {0x00FD, _T("yacute")  /*, Html3, 253 */ },//097 � latin small letter y with acute
    {0x00FE, _T("thorn")   /*, Html3, 254 */ },//098 � latin small letter thorn
    {0x00FF, _T("yuml")    /*, Html3, 255 */ },//099 � latin small letter y with diaeresis
    {0x0152, _T("OElig")   /*, HTML4, 338 */ },//100 � latin capital ligature OE
    {0x0153, _T("oelig")   /*, HTML4, 339 */ },//101 � latin small ligature oe
    {0x0160, _T("Scaron")  /*, HTML4, 352 */ },//102 � latin capital letter S with caron
    {0x0161, _T("scaron")  /*, HTML4, 353 */ },//103 � latin small letter s with caron
    {0x0178, _T("Yuml")    /*, HTML4, 376 */ },//104 � latin capital letter Y with diaeresis
    {0x0192, _T("fnof")    /*, Lat_B, 402 */ },//105 � latin small f with hook = function = florin
    {0x02C6, _T("circ")    /*, HTML4, 710 */ },//106 � modifier letter circumflex accent
    ...
    {0x03B2, _T("beta")    /*, Greek, 946 */ },//133 � greek small letter beta
    ...
    {0x03BC, _T("mu")      /*, Greek, 956 */ },//143 � greek small letter mu
    ...
    {0x2118, _T("weierp")  /*, MathL,8472 */ },//188 P script capital P = power set = Weierstra� elliptic function
    ...
    {0x2205, _T("empty")   /*, MathO,8709 */ },//206 � empty set = null set = diameter
