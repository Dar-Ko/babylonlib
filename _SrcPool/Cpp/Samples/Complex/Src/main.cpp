/*$Workfile: S:\_SrcPool\Cpp\Samples\Complex\Src\main.cpp$: implementation file
  $Revision: 1$ $Date: 2007-05-22 17:37:02$
  $Author: Darko Kolakovic$

  Test complex number routines.
...
{
TsWriteToViewLn(_T("Start Complex Number Tests"));
TsWriteToViewLn(_T(""));
int nRetCode = EXIT_SUCCESS;

nRetCode = TestCommonComplex();
return nRetCode;
}
...
/******************************************************************************
 * $Log: 
 *  1    Biblioteka1.0         2007-05-22 17:37:02  Darko Kolakovic 
 * $
 *****************************************************************************/
