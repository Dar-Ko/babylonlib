...
//      run nmake -f TestComAtlps.mk in the project directory.
...
OBJECT_ENTRY(CLSID_TestAtlObj, CTestAtlObj)
END_OBJECT_MAP()
...
if (dwReason == DLL_PROCESS_ATTACH)
  {
  _Module.Init(ObjectMap, hInstance, &LIBID_TestComAtlLib);
