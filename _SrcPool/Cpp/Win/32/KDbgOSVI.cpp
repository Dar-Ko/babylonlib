...
/*Dump the operating system version information. Function creates a list based on
  OSVERSIONINFO or OSVERSIONINFOEX structure.
    ...
    struct _OSVERSIONINFOEXA {
      ...
      #elif  _VER_osviInfoEX >= 4 (or ==3) build 087 //as defined in WinNT. h build 087 but _VER_osviInfoEX = 3 !! D.K.
  ...
  wSuiteMask member can have one or more of the following values:
    ...
    VER_SUITE_SMALLBUSINESS             0x001 Microsoft Small Business Server is installed.
    VER_SUITE_ENTERPRISE                0x002 Windows 2000 Advanced Server is installed.
    VER_SUITE_BACKOFFICE                0x004 Microsoft BackOffice components are installed.
    ...
    VER_SUITE_DATACENTER                0x080 Windows 2000 Datacenter Server is installed.
    VER_SUITE_SINGLEUSERTS              0x100
    VER_SUITE_PERSONAL                  0x200 Windows XP Home Edition is installed.
    VER_SUITE_BLADE                     0x400 Windows Server 2003, Web Edition is installed.
    VER_SUITE_EMBEDDED_RESTRICTED       0x800
    VER_SUITE_SECURITY_APPLIANCE        TODO: Windows Server 2003 is installed
                                              as a hardened operating system as
                                              part of a security appliance. 
