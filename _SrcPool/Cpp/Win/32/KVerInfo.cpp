/*$Workfile: KVerInfo.cpp$: implementation file
  $Revision: 10$ $Date: 2005-03-04 00:51:09$
  $Author: Darko$
 ...
 */
BOOL CVersionInfo::GetProductName(LPTSTR& strProductName, //[out] resulting string
...
BOOL CVersionInfo::GetProductName(CString& strProductName, //[out] resulting string
                                  UINT nTransTableIndex //[in]=0 index of
                                                        //Translation Table entry
                                 )
{
...
/*Gets the version of the product this file is distributed with.
  A product version number is a 64-bit number that holds the version number
  as follows:

    - The first 16 bits are the MajorNumber.
    - The next 16 bits are the MinorNumber.
    - The third set of 16 bits are the BuildNumber.
    - The last 16 bits are the PrivatePartNumber.

  If the file is the part of the large product, like DLL libraries are, product
  and file versions could differ.
  Typically, a version number is displayed as
    "MajorNumber.MinorNumber.BuildNumber.PrivatePartNumber".

  Returns: TRUE and Product Version entry, if successful; otherwise
  returns FALSE.
 ...
 */
BOOL CVersionInfo::GetProductVersion(LPTSTR& strProductVersion, //[out] resulting string
                                     UINT nTransTableIndex //[in]=0 index of
                                                           //Translation Table entry
                                    )
{
...
BOOL CVersionInfo::GetProductVersion(CString& strProductVersion, //[out] resulting string
                                     UINT nTransTableIndex //[in]=0 index of
                                                           //Translation Table entry
                                    )
{
 ...
 */
BOOL CVersionInfo::GetCopyright(LPTSTR& strCopyright, //[out] resulting string
                                UINT nTransTableIndex //[in]=0 index of
                                                      //Translation Table entry
                               )
{
...
BOOL CVersionInfo::GetCopyright(CString& strCopyright, //[out] resulting string
                                UINT nTransTableIndex //[in]=0 index of
                                                      //Translation Table entry
                               )
{
 ...
 */
BOOL CVersionInfo::GetInternalName(LPTSTR& strInternalName, //[out] resulting string
                                   UINT nTransTableIndex //[in]=0 index of
                                                         //Translation Table entry
                                  )
{
...
BOOL CVersionInfo::GetInternalName(CString& strInternalName, //[out] resulting string
                                   UINT nTransTableIndex //[in]=0 index of
                                                         //Translation Table entry
                                  )
{
 ...
 */
BOOL CVersionInfo::GetLanguage(CString& strLanguage, //[out] resulting string
                               UINT nTransTableIndex //[in]=0 index of
                                                     //Translation Table entry
                               )
{
 ...
 */
int CVersionInfo::GetCharacterSet(UINT nTransTableIndex//[in]=0 index of
                                                       //Translation Table entry
                                 )
{
if (IsVersionInfo())
...
/*If successful returns language code identifier, otherwise returns -1.
  The language code identifier is one of the following:
     ...
     */
int CVersionInfo::GetLanguageCode(UINT nTransTableIndex//[in]=0 index of
                                                       //Translation Table entry
                                 )
{
if (IsVersionInfo())
 ...
 */
BOOL CVersionInfo::GetCompanyName(LPTSTR& strCompanyName, //[out] resulting string
                                  UINT nTransTableIndex //[in]=0 index of
                                                        //Translation Table entry
                                 )
{
...
BOOL CVersionInfo::GetCompanyName(CString& strCompanyName, //[out] resulting string
                                  UINT nTransTableIndex //[in]=0 index of
                                                        //Translation Table entry
                                 )
{
...
/*Gets the file version number.
  ...
  If the file is the part of the large product, like DLL libraries are, product
  and file versions could differ.
  Typically, a file number is displayed as
    "MajorNumber.MinorNumber.BuildNumber.PrivatePartNumber".
 ...
 */
BOOL CVersionInfo::GetFileVersion(LPTSTR& strFileVersion, //[out] resulting string
                                  UINT nTransTableIndex //[in]=0 index of
                                                        //Translation Table entry
                                 )
{
...
BOOL CVersionInfo::GetFileVersion(CString& strFileVersion, //[out] resulting string
                                  UINT nTransTableIndex //[in]=0 index of
                                                        //Translation Table entry
                                 )
{
 ...
 */
BOOL CVersionInfo::GetFileDescription(LPTSTR& strFileDescription, //[out] resulting string
                                      UINT nTransTableIndex //[in]=0 index of
                                                            //Translation Table entry
                                     )
{
...
BOOL CVersionInfo::GetFileDescription(CString& strFileDescription, //[out] resulting string
                                      UINT nTransTableIndex //[in]=0 index of
                                                            //Translation Table entry
                                     )
{
 ...
 */
BOOL CVersionInfo::GetFixedFileInfo(VS_FIXEDFILEINFO& vsffiData //[out] version-
...
//::GetWindowsVersion()--------------------------------------------------------
                      ...
                      //KWinVers.h header file  Jan 2k D.K.
  ...
  */
  BOOL CVersionInfo::GetWindowsVersion(CString& strWinVersion //[out] Windows
                                                              //version
                                      )
  {
...
/*****************************************************************************
 * $Log:
 *  9    Biblioteka1.8         2004-10-01 22:35:42  Darko           stdafx.h
 *  8    Biblioteka1.7         2003-08-09 14:12:00  Darko           deleted
 *       #include StdAfx.h
 *  7    Biblioteka1.6         2003-08-06 22:48:57  Darko           Unicode fix
 *  6    Biblioteka1.5         2003-08-06 03:46:47  Darko           Prepared for
 *       Unicode
 *  5    Biblioteka1.4         2002-01-25 16:59:22  Darko           Updated
 *       comments
 *  4    Biblioteka1.3         2001-08-19 23:56:00  Darko           Butyfier
 *  3    Biblioteka1.2         2001-07-11 22:53:20  Darko
 *  2    Biblioteka1.1         2001-06-08 23:52:19  Darko           VSS
 *  1    Biblioteka1.0         2000-08-13 16:02:53  Darko
 * $
 *****************************************************************************/
