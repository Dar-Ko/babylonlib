  ...
  case VER_PLATFORM_WIN32_WINDOWS:
    ...
    if(osviInfo.dwMajorVersion != ENV_PLATFORM_MAJ_WIN9x)
      ...
      switch (osviInfo.dwMinorVersion)
        {
        case ENV_PLATFORM_MIN_WIN95: strWinOS = _T("95"); 
          if ( osviInfo.szCSDVersion[1] == 'C' || osviInfo.szCSDVersion[1] == 'B' )
            strWinOS += _T("OSR2");
          break;
        case ENV_PLATFORM_MIN_WIN98: strWinOS = _T("98");
    ...
    switch(osviInfo.dwMajorVersion)
      ...
      case ENV_PLATFORM_MAJ_WIN2K:
        ...
        switch (osviInfo.dwMinorVersion)
          ...
          case ENV_PLATFORM_MIN_WIN2k3SER: strWinOS = _T("2000 Server 2003"); break;
          default:                         strWinOS = _T("??");
          }
        }
        break;
