 ...
 */
void CPropertySheetResizable::RecalcLayout(CWnd* pParent //[in]=NULL parent window
                                           )
{
CRect rect;
if (pParent == NULL)
...
/*The framework calls this member function during initialization of the
  resizable wizard property sheet. This function enables resizing of the
  "Apply Now", "OK", "Cancel" and "Help" buttons.
 ...
 */
int CPropertySheetResizable::OnCreate(LPCREATESTRUCT lpCreateStruct //[in]
                     //structure that contains information about the CWnd object
                     //being created
                                      )
{
 ...
 */
void CPropertySheetResizable::OnSize(UINT nType,//[in] type of resizing requested
...
/*The framework calls this member function whenever Windows needs to know the maximized
  ...
  on creation.
 */
void CPropertySheetResizable::OnGetMinMaxInfo(MINMAXINFO FAR* lpMMI //[in]
                                        //structure that contains tracking size
                                              )
{
...
/*****************************************************************************
 * $Log:
 *  5    Biblioteka1.4         2002-01-29 15:41:05  Darko           Tag update
 *  4    Biblioteka1.3         2001-08-19 23:54:39  Darko           Butyfier
 *  3    Biblioteka1.2         2001-07-11 22:52:16  Darko
 *  2    Biblioteka1.1         2001-06-08 23:51:25  Darko           VSS
 *  1    Biblioteka1.0         2000-08-13 15:57:08  Darko
 * $
 *****************************************************************************/
