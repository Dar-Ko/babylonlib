...
public:
  ...
  BOOL GetReadDateTime(COleDateTime& dtValue, LPCTSTR lpszValueName = NULL);
  BOOL SetDateTime(COleDateTime dtValue, LPCTSTR lpszValueName);
  BOOL GetRealNumber(double& dValue, LPCTSTR lpszValueName = NULL);
  BOOL SetRealNumber(double dValue, LPCTSTR lpszValueName = NULL);
// Overrides
 ...
 *  11   Biblioteka1.10        2002-01-29 23:21:39  Darko           Used libraries
 *       notes 
 *  10   Biblioteka1.9         2002-01-24 19:19:19  Darko           Updated
 *       comments
 *  9    Biblioteka1.8         2001-08-19 23:54:52  Darko           Beautyfier
