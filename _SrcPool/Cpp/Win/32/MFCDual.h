/*$RCSfile: MFCDual.h,v $: header file
...
////////////////////////////////////////////////////////////////////////////////
/*BEGIN_DUAL_INTERFACE_PART is just like BEGIN_INTERFACE_PART, except that it
  also adds the IDispatch methods to your class declaration. To define an
  implementation class for your dual interface, add a DUAL_INTERFACE_PART
  block to your object class definition.
  ...
  IDispatch, END_DUAL_INTERFACE_PART.
 */
...
///////////////////////////////////////////////////////////////////////////////
/*END_DUAL_INTERFACE_PART is just like END_INTERFACE_PART. It is only added for
   symmetry.
...
///////////////////////////////////////////////////////////////////////////////
/*DELEGATE_DUAL_INTERFACE expands to define the standard IDispatch  methods for
  a dual interface, delegating back to the default MFC implementation.
...
///////////////////////////////////////////////////////////////////////////////
/*TRY_DUAL is used to provide exception handling  for your
  dual interface methods. CATCH_ALL_DUAL takes care of returning the appropriate
  error code.

  Example:
      STDMETHODIMP CMyDoc::XDualAClick::put_text(BSTR newText)
        {
...
/*CATCH_ALL_DUAL is used to provide exception handling  for your
  dual interface methods. CATCH_ALL_DUAL takes care of returning the appropriate
  error code. CATCH_ALL_DUAL determines the error code to return based on the
...
///////////////////////////////////////////////////////////////////////////////
/*IMPLEMENT_DUAL_ERRORINFO expands to an implementation of  ISupportErrorInfo
  which matches the declaration in DECLARE_DUAL_ERRORINFO.
