...
#if (_WIN32_IE >= 0x0500)
#define MSG_NM_LDOWN(nIdentifier, Function) CC_MSG_WM_NOTIFY(MSG_NM_LDOWN, NMKEY, nIdentifier, Function)
#define MSG_NM_RDOWN(nIdentifier, Function) CC_MSG_WM_NOTIFY(MSG_NM_RDOWN, NMKEY, nIdentifier, Function)
...
#endif // (_WIN32_IE >= 0x0401)
#if (_WIN32_IE >= 0x0500)
#define MSG_TBN_LDOWN(nIdentifier, Function) CC_MSG_WM_NOTIFY(MSG_TBN_LDOWN, NMKEY, nIdentifier, Function)
#endif // (_WIN32_IE >= 0x0500)
#if !defined(_UNICODE)
...
#if (_WIN32_IE >= 0x0400)
#define MSG_LVN_RCLICK(nIdentifier, Function) CC_MSG_WM_NOTIFY(NM_CLICK, NMITEMACTIVATE, nIdentifier, Function) // NMHDR prior to 4.71
#define MSG_LVN_RDBLCLK(nIdentifier, Function) CC_MSG_WM_NOTIFY(NM_DBLCLK, NMITEMACTIVATE, nIdentifier, Function) // NMHDR prior to 4.71
#else
