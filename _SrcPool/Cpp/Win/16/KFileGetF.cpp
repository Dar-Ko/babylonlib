/*$Workfile: KFileGetF.cpp$: implementation file
  $Revision: 2$ $Date: 2005-05-24 12:21:56$
...
_asm
  {
  mov ax, 0x7160    //GetFullPathName()
  mov cl, 0         //1: short path form; 0: full path and filename
  mov ch, 0
  lds si, farFileName
  les di, farDestPath
  int 21h
...
/*****************************************************************************
 * $Log:
 *  1    Biblioteka1.0         2002-08-27 17:04:31  Darko Kolakovic
 * $
 * Jan 93 Darko Kolakovic
 *****************************************************************************/
