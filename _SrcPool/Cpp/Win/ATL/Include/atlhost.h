/*$RCSfile: atlhost.h,v $: header file
  $Revision: 1.5 $ $Date: 2008/07/15 20:31:09 $
  $Author: ddarko $
...
// Group=Windows
  ...
  #define __ATLHOST_H__ "ATL-3_00_PSDK_200603"
...
#endif
#ifdef __BORLANDC__
  public CWindowImpl<CAxFrameWindow,CWindow,CControlWinTraits>,
#endif
...
#endif
#ifdef __BORLANDC__
  public CWindowImpl<CAxUIWindow,CWindow,CControlWinTraits>,
#endif
...
#endif
#ifdef __BORLANDC__
    public CWindowImpl<CAxHostWindow,CWindow,CControlWinTraits>,
#endif
...
#endif
#ifdef __BORLANDC__
    HDC hdc = CWindowImpl<CAxHostWindow,CWindow,CControlWinTraits>::GetDC();
#endif
    if (hdc == NULL)
      return E_FAIL;
    if (m_spViewObject)
...
#endif
#ifdef __BORLANDC__
    CWindowImpl<CAxHostWindow,CWindow,CControlWinTraits>::ReleaseDC(hdc);
#endif
    return S_OK;
  }
...
#endif
#ifdef __BORLANDC__
    *phDC = CWindowImpl<CAxHostWindow,CWindow,CControlWinTraits>::GetDC();
#endif
    return S_OK;
  }
...
#endif
#ifdef __BORLANDC__
    CWindowImpl<CAxHostWindow,CWindow,CControlWinTraits>::InvalidateRect(pRect, fErase);
#endif
    return S_OK;
  }
...
#endif
#ifdef __BORLANDC__
    CWindowImpl<CAxHostWindow,CWindow,CControlWinTraits>::InvalidateRgn(hRGN, fErase);
#endif
    return S_OK;
  }
...
#endif
#ifdef __BORLANDC__
    m_bSubclassed = CWindowImpl<CAxHostWindow,CWindow,CControlWinTraits>::SubclassWindow(hWnd);
#endif
  }
 ...
 *
 * Revision 1.1.2.4  2008/07/15 19:51:04  ddarko
 * Minor fixes
 *
 * Revision 1.1.2.3  2008/07/15 15:18:03  ddarko
