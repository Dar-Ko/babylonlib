...
#ifndef __ATLCTL_H__
  #define __ATLCTL_H__ "ATL-3_00_PSDK_200603"
...
#ifdef __BORLANDC__
  //BorlandCC
  template <class T, class WinBase =  CWindowImpl< T, CWindow, CControlWinTraits > >
#endif
...
#ifdef __BORLANDC__
  //BorlandCC
  class CComCompositeControl : public CComControl< T, CAxDialogImpl< T, CWindow > >
#endif
{
public:
  CComCompositeControl()
...
//Implementation
  ...
  virtual HRESULT OnDraw(ATL_DRAWINFO& di)
  {
    ...
    #ifdef __BORLANDC__
      //BorlandCC
    typedef CComControl< T, CAxDialogImpl< T, CWindow > > baseClass;
     #endif
 ...
 *
 * Revision 1.1.2.4  2008/07/15 19:51:03  ddarko
 * Minor fixes
 *
 * Revision 1.1.2.3  2008/07/15 15:18:02  ddarko
