/*$Workfile: KDbgFILE.c$: implementation file
  $Revision: 3$ $Date: 29/01/2002 10:20:13 PM$
  $Author: Darko$
 ...
 */
void DumpFILE(FILE* fileStream /*pointer to FILE structure*/)
{
 ...
 */
void DumpFILEOrigin(long offset, /*number of bytes from origin*/
