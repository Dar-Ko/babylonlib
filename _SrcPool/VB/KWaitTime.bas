...
'-------------------------------------------------------------------------------
'Waits for certain period of time before signaling time expiration.
'Subroutine uses kernal's waitable timer.
'Parameter:
'  lInterval waiting period in milliseconds
'
'See also: Microsoft Knowledge Base:
'Microsoft Knowledge Base 231298 How To Use SetWaitableTimer With Visual Basic;
'Microsoft Knowledge Base 184796 How To Use a Waitable Timer with an Asynchronous
'Procedure Call
Public Sub Wait(lInterval As Long)
  Dim ft As FILETIME
  Dim lBusy As Long
  Dim lRet As Long
